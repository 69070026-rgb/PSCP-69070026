...
```text
input:
รับค่าจำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่ม
Output: 
เงินที่ลูกค้าต้องชำระหลังจากรวมค่าบริการและ VAT 7% แล้ว
Constraints:
กำหนดค่าบริการไว้ 10% ค่าบริการจะคิดอย่างน้อย 50 บาท แต่จะไม่เกิน 1000 บาท 
```
...
```text
1. รับค่าเงิน และกำหนดค่า vat และค่าบริการ
2. กำหนดตัวแปรแรกให้เงิน * ค่าบริการ และอีกตัวคือ เงินที่รวมกับค่าบริการแล้ว * vat
3. ถ้าเงิน อยู่ระหว่าง 500 กับ 1000 ให้พิมเงิน+กับตัวแปรทั้งสอง (ทศนิยม2ตน.)
4. ถ้าเงินน้อยกว่า 500 ให้พิมเงิน+50 *vat แล้ว+ด้วยเงินที่+50 (ทศนิยม2ตน.)
5. ถ้าเงินมากกว่า 1000 ให้พิมเงิน+1000 *vat แล้ว+ด้วยเงินที่+1000 (ทศนิยม2ตน.)
```
...
```text
เหมือนแผนแรก เพราะถ้าค่าน้อยกว่า500หรือมากกว่า 1000 ค่าที่คำนวณออกมาถูกต้อง
```
...
```text
อยากรู้ว่าค่าที่น้อยกว่า500 มีผลลัพท์เท่าไหร่
```
