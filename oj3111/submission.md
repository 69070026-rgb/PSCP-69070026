...
```text
1. รับค่าสถานะ และ จำนวนสินค้า
2. loop ตามจำนวนสินค้า แล้วใส่ราคาตาม 
3 คำนวนผลรวมราคาสินค้า
4. สร้างเงื่อนไขถ้าเป็นสมาชิก ให้ลด
5. หรือไม่เป็นแต่ราคาสินค้า มากกว่า500
6.อื่นๆ ไม่ลด
7. แสดงผลราคา
```
