...
```text
Input:
รับค่าแต้มของไพ่และกลุ่มของไพ่
Output:
ชื่อของไพ่

Constraints:
ตัวอักษรภาษาอังกฤษนั้นสามารถรับได้ทั้งพิมพ์ใหญ่พิมพ์เล็ก
```
...
```text
1.รับค่าแต้มของไพ่และกลุ่มของไพ่และทำให้เป็นตัวใหญ่ทั้งหมด
2. ตั้งค่าตัวแปรเก็บแต้มและ กลุ่ม
3 ถ้าตัวแปรมีจำนวน 3 ตัว ให้ เก็บค่า2ตัวแรกใน แต้ม และตัวสุดท้ายในกลุ่ม
4.แปลงกลุ่มเป็นชื่อไพ่ตามตัวอักษรนั้นๆ
5.แสดงผล
```
