...
```text
Input:
รับค่าระยะกระโดดและ จุดสิ้นสุด
Output:
จำนวนครั้งในการกระโดด

Constraints:
ถ้าไปไม่ถึง ให้แสดงค่า -1
```
...
```text
1.รับค่าระยะกระโดดและ จุดสิ้นสุด ในบรรทัดเดียวกัน
2. ตั้งค่าตัวแปรเก็บจำนวนกระโดดและ ระยะทางที่ไปถึง
3 while loop ในขณะที่ ระยะทางที่ไปถึง น้อยกว่า จุดสิ้นสุด
4.ถ้า   จุดสิ้นสุด <= 0 ให้ = -1 และพังลูป
5.ให้ระยะทางที่ไปถึง += ระยะกระโดด
6.ให้ระยะกระโดด - 2
7. จำนวนกระโดด += 1
8.แสดงผลจพนวนกระโดด
```
