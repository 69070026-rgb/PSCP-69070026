...
หาจำนวนเฉพาะ
Input:
รับค่าเริ่มต้นและ ค่าสุดท้าย

Output:
จํานวนเฉพาะ ที่อยู่ในช่วง
จำนวนทั้งหมดของจำนวนเฉพาะ
...
```text
1.รับค่าเริ่มต้นและ ค่าสุดท้าย
2.ตั้งลิสเปล่าให้จำนวนเฉพาะ
3. ฟอร์ลูป ค่าเริ่มต้น ถึง ค่าสุดท้าย + 1
4. ถ้า i มากกว่า 1 ให้ตัวแปรprime เป็นจริง
5. ฟอร์ลูปหาค่าจำนวนเฉพาะ
6 ถ้า i % j == 0 ค่าตัวแปรprime เป็นเท็จ แล้วหยุดลูป
7. ถ้าค่าตัวแปรprime ยังเป็นจริง ใส่เก็บค่าใส่ในลิส
8.ถ้า จำนวนตัวในลิส > 0 แสดงผลจำนวนเฉพาะ ทั้งหมด
9 แสดงผลจำนวนตัวจำนวนเฉพาะทั้งหมด
```
...
```text
ใช้เหมือนเดิม เพราะค่าออกมาถูกต้อง
```
...
```text
กรณี ค่าเริ่มต้นกับค่าสุดท้าย อันเดียวกัน
```
