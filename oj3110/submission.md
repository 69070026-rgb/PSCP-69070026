...
```text
คำนวนค่าส่งตามเส้นทางและน้ำหนัก
input:
ต้นทาง ปลายทาง
น้ำหนักพัสดุ
output:
...
```text
1.รับค่า ต้นทาง ปลายทาง น้ำหนัก
2. สร้างตัวแปร เพื่อจับคู่เส้นทาง
3 สร้างตารางเส้นทางตามราคา
4. สร้างเงื่อนไขถ้าจับคู่ไม่ตรงให้ error
5.ถ้าจับคู่ได้ ให้ดึงราคามาคำนวณ
6.แสดงผลราคา
```
