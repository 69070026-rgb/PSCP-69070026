...
Output:
แจ้งว่า มีโอกาสที่จะเกิด Surprising หรือไม่
Constraints:
คะแนน 0-10
...
```text
1. รับค่าคะแนนรวม และค่าคะแนนที่มากที่สุด
2. หาค่าคะแนนที่เหลือ หลังเอาคะนนนทั้งสองมาลบ
3. หาคะแนนต่ำสุด จาก max ของค่าที่เหลือ - คะแนนมากที่สุด
4. หา คะแนนห่างจาก คะแนนมากสุด - ต่ำสุด
5. ถ้า ห่างมากกว่า2 พิมSurprising ถ้าไม่พิม Not surprising
```
...
```text
ใช้เหมือนเดิม เพราะค่าที่ออกมาถูกต้อง
