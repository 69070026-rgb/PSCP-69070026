...
```text
1. รับค่าข้อความ
2. กำหนดตัวแปรของสระที่นับได้แต่ละตัว
3. ถ้าสระตัวไหนมีค่า มากกว่า0 ให้พิม
...
```text
ใช้เหมือนเดิม แต่เพิ่มการนับตัวพิมใหญ่
```
