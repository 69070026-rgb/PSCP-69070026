...
หาร้านที่เปิดอยู่
Input:
รับค่าจำนวนร้าน และ จำนวนช่วงเวลา
รับค่าเวลาเปิดปิดของแต่ละร้าน
ช่วงเวลาที่ต้องการตรวจสอบ
Output:
จำนวนร้านที่เปิดอยู่ในเวลานั้น
Constraints:
พิมพ์ต่อกันในบรรทัดเดียว คั่นด้วยช่องว่าง
```
...
```text
1. รับค่าจำนวนร้าน และ จำนวนช่วงเวลา
2.รับค่าเวลาเปิดปิดของแต่ละร้าน
3. รับค่าช่วงเวลาที่ต้องการตรวจสอบ
4. ลูปดูเวลาที่ต้องการเช็ค
5 ลูปนับจำนวนร้านค้า
6. แสดงผล
```
