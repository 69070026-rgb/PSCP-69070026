...
```text
input:
รับค่า เดือนกับ วันที่
output:
ชื่อฤดูกาล
constraints ตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว จะเปลี่ยนฤดูไป
```
...
```text
1. รับค่าเดือนกับวันที่ 
2. ถ้าเดือน = 3 วันที่มากกว่า= 21 .ให้พิมฤดูที่เปลี่ยน
3. ทำซ้ำกับที่เหลือ
4. ถ้าไม่ใช่ ให้พิม ฤดูที่อยู่ในเดือนนั้นเลย
...
```text
สร้าง list มา เพื่อลดการใช้if  ที่เยอะเกินไป 
```
...
```text
เดือนหาร3ได้ลงัตวแต่วันที่น้อยกว่า21
```
