...
```text
Input:
รับค่าความหนา และ จำนวนช่องที่ปลูกดอกไม้

Output:
หมายเลขของแถบของช่องสุดท้ายที่มีการปลูกดอกไม้ 
```
...
```text
1.รับค่าความหนา และ จำนวนช่องที่ปลูกดอกไม้
2. กำหนดตัวแปรจำนวนรอบ = 1
3. สร้างลูป
4. กำหนดตัวแปร d = ความยาวของแถวจาก รอบ * ความหนา
5. หาผลรวมทั้งหมด 
6. ถ้าผลรวม >= จำนวนช่องที่ปลูก ให้แสดงผลแล้วหยุดลูป
7.ถ้าไม่ ให้ จำนวนรอบ+= 1
```
...
```text
ใช้เหมือนเดิมเพราะค่าออกมาถูกต้อง
...
```text
กรณีที่ผลรวมสะสมพอดีกับจำนวนช่อง
```
...
```text
กรณีที่ผลรวมสะสมมากกว่าจำนวนช่อง
```
