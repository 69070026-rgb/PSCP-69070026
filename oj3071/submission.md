...
รับค่า A B d r
output:
จำนวนที่อยู่ในช่วง A-B แล้วหารด้วย d แล้วเหลือเศษ r
constraints:
นับค่า A กับ B ด้วย
```
...
1. รับค่า A B d r
2. สร้างlist
3 ใช้คำสั่งให้อยู่ในช่วง A จบที่ B
4. ถ้าค่าไหน หารด้วย d แล้วเหลือ เศษ r ให้ใส่ในlist
5. พิมจำนวนทั้งหมดในลิสว่ามีกี่ตัว
```
...
```text
ใช้เหมือนเดิม เพราะ ค่าออกมาถูกต้อง
```
...
```text
เพราะไม่มีตัวไหนที่เหลือเศษตามที่กำหนดมา
```
