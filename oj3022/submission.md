...
```text
input:
รับค่าอุณหภูมิ หน่วย และหน่วยที่ต้องการเปลี่ยน
output:
ค่าอุณหภูมิ ของหน่วยที่เปลี่ยน
constraints:
คำตอบเป็นจำนวนจริง และทศนิยม2ตน.
```
...
```text
1. รับค่าอุณหภูมิ หน่วย และหน่วยที่ต้องการเปลี่ยน
2. สร้างสูตรคำนวณแปลงค่าอุณหภูมิของแต่ละหน่วยไปกลับ
3. หรือถ้า เป็นหน่วยเดียวกัน ให้ตอบค่าที่ให้มาเลย
```
...
```text
ใช้ เหมือนแผนแรกเพราะ ค่าสามารถคำนวณได้ถูกต้อง
