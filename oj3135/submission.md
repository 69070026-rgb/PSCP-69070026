...
```text
หาจำนวนรอบที่ส่งของขวัญ
Input:
รับค่า จำนวนคน ระยะห่างที่ส่ง คนที่ขโมย

Output:
จำนวนรอบที่ส่ง

Constraints:
ถ้าหยุดที่คนแแรกให้หยุดนับ นับรวมตอนเหตูการณ์ที่ขโมยด้วย
```
...
```text
1.รับค่า จำนวนคน ระยะห่างที่ส่ง คนที่ขโมย ในบรรทัดเดียวกัน
2 ตั้งตัวแปรตำแหน่ง = 1
3. ตั้งตัวแปรจำนวนรอบ = 1
4. ถ้า คนที่ขโมย == ตำแหน่ง แสดงผลรอบได้เลย
5. ลูปในขณะที่เป็นจริง
6. ให้หาค่าตำแหน่งต่อไปเรื่อยๆ
7.ถ้าตำแหน่ง ==  1 หยุดลูป
8. บวกจำนวนรอบไปเรื่อยๆ
9 ถ้าตำแหน่ง == t หยุดลูป
10. แสดงผลรอบ
```
