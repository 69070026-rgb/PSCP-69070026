...
```text
ให้ช่วยอธิบายโจทย์ และถามว่า จะหาจำนวนการใช้ ก้อนb ยังไงดี
```
...
```text
แนะนำให้ลองใช้ min ระหว่างค่า  b กับ ค่าของ goal
```
...
```text
ไม่ได้แก้ไขอะไรมากเพราะผมติดอยู่ที่เดียว
```
