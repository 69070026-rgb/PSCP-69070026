...
```text
input:
รับค่าจำนวน อิฐเล็ก a กับ ใหญ่b
output:
จำนวนอิฐก้อนเล็กที่ต้องใช้ ถ้าสร้างไม่ได้ ตอบ -1
Constraints:
ใช้อิฐก้อนใหญ่ให้ได้มากที่สุดก่อนจะใช้อิฐก้อนเล็กเสมอ
```
...
```text
1. รับค่าอิฐเล็ก a กับ ใหญ่b
2. หาจำนวนอิฐใหญ่ที่ใช้
3. หาจำนวนอิฐเล็กที่ใช้
4. ถ้า ค่า a >= จำนวนอิฐเล็กที่ต้องการใช้  ให้พิม จำนวนอิฐเล็กที่ต้องการใช้
5. ถ้าไม่ พิม -1
```
...
```text
เพราะทดลองกรณีที่ ก้อนb สามารถสร้างได้เลย
```
