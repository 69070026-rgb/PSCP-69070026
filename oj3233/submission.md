...
Input:
รับค่าผลสลากกินแบ่ง
และ สลากกินแบ่งที่ซื้อ

Output:
จำนวนเงินที่ได้

Constraints:
รางวัลสูงสุดเพียงรางวัลเดียว ถ้าไม่ถูกรางวัล ให้แสดงผลลัพธ์เป็น 0
```
...
```text
1.รับค่า ตัวอักษรและ เลขของสลากที่ถูก ในบบรทัดเดียวกัน
2.รับค่า ตัวอักษรและ เลขของสลากที่ซื้อ ในบบรทัดเดียวกัน
3.กำหนดตัวแปรรางวัล
3.ทำแต่ละเงื่อนไขและถ้าเข้าเงื่อนไขไหนให้รางวัล = ค่านั้น
4 ถ้าไม่เข้า = 0
5.แสดงผล
...
```text
ถูกเลขท้าย 3 ตัว และ ตัวอักษรตรง
```
