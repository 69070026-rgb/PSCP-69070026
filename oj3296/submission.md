...
Input:
รับความเข้มของแต่ละสี

Output:
ผลลัพธ์การผสมสี

Constraints:
ไม่ต้องมีข้อความอื่นปะปน
```
...
```text
1.รับค่าของแต่ละช่องเก็บไว้ในลิส
2. ตั้งตัวแปรของแต่ละสีให้ ค่าในลิสทั้งสองบวกกัน ที่ตำแหน่งเดียวกัน แล้วหาร2
3.แสดงผล
```
