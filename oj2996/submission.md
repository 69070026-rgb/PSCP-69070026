...
```text
input:
รับค่าขอความแล้วแปลงเป็นตัวพิมเล็ก
Output:
สลับค่าข้อความจากหลังไปหน้า
Constraints:
ต้องเป็นตัวพิมเล็ก
```
...
```text
1. รับค่าข้อความแล้วแปลงเป็นตัวพิมเล็กทั้งหมด
2. พิมข้อความที่สลับหน้าหลังแล้ว
```
...
```text
เหมือนแผนแรก เพราะค่าออกมาแล้วกลับหน้าหลังได้ถูกต้องและเป็นตัวพิมเล็ก
...
```text
ทดสอบค่าที่เป็นตัวพิมใหญ่ทั้งหมด
```
...
```text
แนะนำคำสั่ง ที่สลับค่าจากหลังไปหน้า
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำทุกอย่างที่เหลือยกเว้นแค่คำสั่ง
```
