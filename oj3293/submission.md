...
```text
Input:
รับค่าข้อความ 5 บรรทัด

Output:
ข้อความที่ใส่กรอบ *

Constraints:
กรอบต้องมีขนาดใหญ่ตามบรรทัดที่ยาวที่สุด
```
...
```text
1. สร้างลิสเปล่า
2. สร้างลูปเพื่อรับข้อความ 5 บรรทัดและเก็บไว้ในลิส
3. ตั้งตัวแปรหาจำนวนข้อความแต่ละบรรทัดที่ยาวที่สุด
4. สร้างกรอบบนและล่าง
5.แสดงผลกรอบส่วนบน และ ลูปข้อความในลิสมาใส่ และเติม * หน้าหลัง
6.แสดงผลกรอบล่าง
```
