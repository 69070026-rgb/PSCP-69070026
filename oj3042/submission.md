...
รับค่าตัวเลข 1 ชุด
output:
ค่าของตัวที่รับมาไล่ลงไปเรื่อยๆจนถึง 0 แล้วหารด้วย10 ลงตัว
constraints:
คั่นข้อมูลแต่ละตัวด้วยช่องว่าง
```
...
```text
1.รับค่า
2.เอาตัวเลขที่รับมาไปอยู่ในช่วงแล้วไล่ไปถึง0
3 ถ้าค่าไหนหารด้วย10ลงตัว ให้พิม แล้ว เว้นวรรคคั่น
```
...
```text
เพราะทดลองค่าที่ 10 หารลงตัวได้เลย
```
